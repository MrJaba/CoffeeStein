...
castSingleRay = (rayAngle, stripId) ->
  ...
  [dist, wallType, textureX] = checkVerticalLines(right, up, angleSin, angleCos)
...
checkVerticalLines = (right, up, angleSin, angleCos) ->
